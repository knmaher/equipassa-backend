...
@Service
public class PasswordResetTokenProvider implements ActionTokenProvider {
    private final ActionTokenRepository actionTokenRepository;

    public PasswordResetTokenProvider(final ActionTokenRepository actionTokenRepository) {
    ...
    public ActionToken generateToken(final Long userId, final int expirationMinutes) {
        ...
        token.setType(ActionTokenType.PASSWORD_RESET);
    ...
    public ActionToken validateToken(final String token) {
        final Optional<ActionToken> actionToken = actionTokenRepository.findByTokenAndTypeAndVisibilityAndConsumedFalse(
                token, ActionTokenType.PASSWORD_RESET, TokenVisibility.PRIVATE
        );
    ...
    public ActionTokenType getSupportedTokenType() {
        return ActionTokenType.PASSWORD_RESET;
    }
}